-- Create function to update inventory without logging movements (for current stock uploads)
...
BEGIN
    ...
    INSERT INTO current_inventory (store_id, product_id, quantity, available_quantity)
    VALUES (p_store_id, p_product_id, p_quantity, p_quantity)
